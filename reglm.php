...
$nameErr =$idErr= $emailErr=$passwordErr=$expErr=$deptErr = $genderErr  = "";
$id=$name = $email  =$password=$exp=$dept=$gender  = "";
...
if ((!empty($_POST["name"])) && (!empty($_POST["id"])) &&(!empty($_POST["email"])) && (!empty($_POST["gender"]))&&(!empty($_POST["password"])) && (!empty($_POST["exp"]))&&(!empty($_POST["dept"])) )
{
	function Connect()
{
 $dbhost = "localhost";
